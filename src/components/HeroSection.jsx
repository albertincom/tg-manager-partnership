    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-dark">
      ...
      <div className="max-w-6xl mx-auto px-4 pt-24 text-center relative z-10">
        ...
        <div className="flex flex-col items-center">
          <button className="bg-gradient-to-r from-brand-blue to-brand-purple text-white px-12 py-4 rounded-full text-lg font-semibold hover:opacity-90 transition shadow-xl transform hover:scale-105 duration-300">
            Get Started
          </button>
        </div>
